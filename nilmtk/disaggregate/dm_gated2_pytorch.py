...
def direct_segment_train_val(mains, appliances, val_rate=0.2):
    pass
...
def train(appliance_name, model: ConditionalDiffusion,
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            print("Sample score: MAE:",
                  losses_cal.mae(appliance_name, flat_truth, flat_output),
                  "F1-score:", losses_cal.f1score(appliance_name, flat_truth, flat_output,
                                                  threshold=threshold))
            ...
            for appliance in self.models:
                ...
                if self.fine_tune:
                    ...
                    if self.scaler == "std":
                        ...
                        print('De-norming, app mean', app_mean, 'app std', app_std)
                        prediction = self.denormalize_output(prediction, app_mean, app_std)
                    else:
        ...
        if method == 'train':
            ...
            for mains in mains_lst:
                ...
                if self.scaler == "std":
                    ...
                    print("Train main max", mains.values.max())
        ...
        if method == 'test':
            ...
            for mains in mains_lst:
                ...
                if self.scaler == "std":
                    ...
                    print("Test main max", mains.values.max())
